...
//go:generate mockgen -destination=mocks/mocks_windows.go -copyright_file=../../../scripts/copyright_file github.com/as14692/amazon-ecs-agent/agent/statemanager/dependencies WindowsRegistry,RegistryKey
